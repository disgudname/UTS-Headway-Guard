...
const INCIDENT_UNIT_STATUS_INFO = Object.freeze({
    ...
    AE: {
        label: 'Available On Scene',
        color: '#cc0000',
        background: 'rgba(204, 0, 0, 0.16)',
        border: 'rgba(204, 0, 0, 0.38)'
    },
    TR: {
        label: 'Transport',
        color: '#ffc107',
    ...
    TA: {
        ...
        border: 'rgba(25, 118, 210, 0.38)'
    },
    AR: {
        label: 'Cleared From Incident',
        color: '#494949',
        background: 'rgba(73, 73, 73, 0.16)',
        border: 'rgba(73, 73, 73, 0.38)'
    }
});
            ...
            if (adminMode && displayMode === DISPLAY_MODES.SPEED && !kioskMode) {
                ...
                if (speedIcon) {
                    ...
                    if (nameBubbles[vehicleID].speedMarker) {
                        ...
                        nameBubbles[vehicleID].speedMarker = L.marker(newPosition, {
                            icon: speedIcon,
                            interactive: false,
                            pane: 'busesPane'
                        }).addTo(map);
            ...
            if (adminMode && !kioskMode) {
                ...
                if (nameIcon) {
                    ...
                    if (nameBubbles[vehicleID].nameMarker) {
                        ...
                        nameBubbles[vehicleID].nameMarker = L.marker(newPosition, {
                            icon: nameIcon,
                            interactive: false,
                            pane: 'busesPane'
                        }).addTo(map);
                ...
                if (displayMode === DISPLAY_MODES.BLOCK && blockName && blockName.includes('[')) {
                    ...
                    if (blockIcon) {
                        ...
                        if (nameBubbles[vehicleID].blockMarker) {
                            ...
                            nameBubbles[vehicleID].blockMarker = L.marker(newPosition, {
                                icon: blockIcon,
                                interactive: false,
                                pane: 'busesPane'
                            }).addTo(map);
        ...
        if (adminMode && displayMode === DISPLAY_MODES.SPEED && !kioskMode) {
            ...
            if (speedIcon) {
                ...
                if (nameBubbles[bubbleKey].speedMarker) {
                    ...
                    nameBubbles[bubbleKey].speedMarker = L.marker(newPosition, {
                        icon: speedIcon,
                        interactive: false,
                        pane: 'busesPane'
                    }).addTo(map);
        ...
        if (adminMode && !kioskMode) {
            ...
            if (nameIcon) {
                ...
                if (nameBubbles[bubbleKey].nameMarker) {
                    ...
                    nameBubbles[bubbleKey].nameMarker = L.marker(newPosition, {
                        icon: nameIcon,
                        interactive: false,
                        pane: 'busesPane'
                    }).addTo(map);
