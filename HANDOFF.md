...
- **Re-tested 2026-09-23 with a schedule-derived `is_timestop_at`: same regression on Sunday logs (>2 min late 3.1% -> 5.0%). Do not wire it in.** Read this entry BEFORE building anything time-aware around the cap.
