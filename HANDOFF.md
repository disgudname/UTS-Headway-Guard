...
### 2026-09-24 · [home] · Evening route change: hide stops the post-6PM route skips (BUILT + tested offline; UNCOMMITTED code on [home], NOT deployed)
...
- **Next:** commit + `fly deploy` when the user says go, then watch the next weekday 17:40 run with `eta_route_change_check.py` and `eta_phantoms.py`.
